defmodule Contas do
  @moduledoc """
  Modulo de Contas para imprimir as contas dos assinantes

  A função mais utilizada é a `imprimir/4`
  """

  @doc """
  Função de imprimir contas de um assinante

  ## Parâmetros

  - mes: Numero do Assinante
  - ano: Data para realização da chamada
  - numero: Duracao da chamada
